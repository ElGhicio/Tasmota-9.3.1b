...
#endif  // USE_UFILESYS
Serial.println(".------------SettingsDefault1: ");
Serial.println((uint16_t)CFG_HOLDER);
Serial.println(max_slots);
Serial.println(slot);
 Serial.println(flash_location);
...
#ifdef USE_UFILESYS
//MP
Serial.println("----------SettingsDefault2------: ");
Serial.println((uint16_t)CFG_HOLDER);
Serial.println(Settings.cfg_holder);
Serial.println(settings_location);
 Serial.println("SettingsDefault2: ");
...
#endif  // USE_UFILESYS
    {
      ...
      //MP
      Serial.println("SettingsDefault3: ");
      Serial.println((uint16_t)CFG_HOLDER);
      Serial.println(Settings.cfg_holder);
      Serial.println(settings_location);
