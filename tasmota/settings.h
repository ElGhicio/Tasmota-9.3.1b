...
struct {
  ...
  uint8_t       mqtt_fingerprint[2][20];   // ECF  3791



  uint8_t       ex_adc_param_type;         // EF7  Free since 9.0.0.1 3831
  ...
  uint8_t       shd_warmup_time;           // F5E 3934

    //MP
  uint16_t      web_portssl;               // F5F 3935
  uint8_t       flag_https;                // F61 3937

  uint8_t       free_F61[69];              // da F5E[72] a F61[69]  Decrement if adding new Setting variables just above and below
